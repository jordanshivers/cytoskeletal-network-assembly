/* ----------------------------------------------------------------------
   ...
   This code was written by the Saric group:
   https://github.com/Saric-Group/BSS2024_LAMMPS_Task/tree/main/LAMMPS_installation/src
------------------------------------------------------------------------- */
...
void PairMembrane::settings(int narg, char **arg)
{
  ...
  rc_global  = utils::numeric(FLERR, arg[0], false, lmp);
...
void PairMembrane::coeff(int narg, char **arg)
{
  ...
  double rmin_one      = utils::numeric(FLERR, arg[4], false, lmp);
  double rc_one        = utils::numeric(FLERR, arg[5], false, lmp);
  double zeta_one      = utils::numeric(FLERR, arg[6], false, lmp);
  double nu_one        = utils::numeric(FLERR, arg[7], false, lmp);
  double theta0_one    = utils::numeric(FLERR, arg[8], false, lmp);
